...
public class LocalSdk {
    ...
    /**
     * Creates an initial LocalSdk instance with an unknown location.
     * This is designed for unit tests to override the {@link LegacyFileOp} being used.
     *
     * @param LegacyFileOp The alternate {@link LegacyFileOp} to use for all file-based interactions.
     */
    @VisibleForTesting(visibility=Visibility.PRIVATE)
    public LocalSdk(@NonNull IFileOp LegacyFileOp) {
