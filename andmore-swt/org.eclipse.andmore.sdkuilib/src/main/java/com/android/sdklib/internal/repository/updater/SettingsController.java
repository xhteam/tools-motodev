...
public class SettingsController {
    ...
    public SettingsController(@NonNull ILogger sdkLog) {
        this(new LegacyFileOp(), sdkLog);
    }

    /**
     * Constructs a new default {@link SettingsController}.
     *
     * @param LegacyFileOp A non-null {@link LegacyFileOp} to perform file operations (to load/save settings.)
     * @param sdkLog A non-null logger to use.
     */
    public SettingsController(@NonNull IFileOp LegacyFileOp, @NonNull ILogger sdkLog) {
        this(LegacyFileOp, sdkLog, new Settings());
    }
    ...
    protected SettingsController(@NonNull IFileOp LegacyFileOp,
                                 @NonNull ILogger sdkLog,
                                 @NonNull Settings settings) {
        mFileOp = LegacyFileOp;
        mSdkLog = sdkLog;
        mSettings = settings;
    }
