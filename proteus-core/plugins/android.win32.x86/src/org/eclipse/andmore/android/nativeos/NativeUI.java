...
/***
 * This class is responsible for provide WIN32 X86 specific constants values and
 * implementation of INativeUI interface
 */
...
public class NativeUI implements INativeUI {
	...
	public void setWindowStyle(long windowHandle) {
		OS.SetWindowLong((int) windowHandle, OS.GWL_STYLE, OS.WS_VISIBLE | OS.WS_CLIPCHILDREN | OS.WS_CLIPSIBLINGS);
	}
