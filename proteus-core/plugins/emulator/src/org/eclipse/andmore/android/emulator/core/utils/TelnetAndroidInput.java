...
public class TelnetAndroidInput extends AbstractInputLogic
{
     ...
     * 
     * @see org.eclipse.andmore.android.emulator.core.model.IInputLogic#sendMouseDown(int, int)
     */
     ...
     * Send mouse up event
     * 
     * @see org.eclipse.andmore.android.emulator.core.model.IInputLogic#sendMouseUp(int, int)
     */
     ...
     * 
     * @see org.eclipse.andmore.android.emulator.core.model.IInputLogic#sendMouseMove(int, int)
     */
