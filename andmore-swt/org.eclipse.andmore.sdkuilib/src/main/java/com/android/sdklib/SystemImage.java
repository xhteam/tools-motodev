...
public class SystemImage implements ISystemImage {
    ...
    public SystemImage(
        ...
        case IN_IMAGES_SUBFOLDER:
            location = LegacyFileOp.append(target.getLocation(), SdkConstants.OS_IMAGES_FOLDER, abiType);
            break;
    ...
    private static File getCanonicalFolder(
        ...
        if (abiType == null) {
            ...
            return LegacyFileOp.append(root, abiType);
        }
    }
